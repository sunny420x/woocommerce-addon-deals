 ...
 * GitHub Plugin URI: https://github.com/sunny420x/woocommerce-addon-deals
        ...
        <div style="display: flex;">
            ...
            <div class="container">
                ...
                <div style="padding: 0 25px 25px 25px;">
                    ...
                    <p>ระบบ Addon Deals คือระบบที่ออกแบบมาเพื่อรองรับการทำการตลาดบนเว็บไซต์ โดยสามารถซื้อของชิ้นที่สองและชิ้นต่อ ๆ ไปได้ในราคาพิเศษ โดยเราจะเรียกโดยรวมว่า Addon Deals ในระบบสามารถเลือกกลุ่มสินค้าทั้งกลุ่ม หรือเป็นรายชิ้นได้
                    </p>
